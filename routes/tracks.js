...
const { getItems, getItem, createItem, updateItem, deleteItem } = require("../controllers/tracks"); // importamos del controlador las funciones
const checkRol = require("../middleware/rol");

//TODO http://localhost/tracks aquí se realizar ael CRUD (GET, POST, DELETE, PUT)
